...
class __TwigTemplate_b0c34173b1fdd40990a83fd00aeeda8e extends Template
{
    private $source;
    private $macros = [];
...
<!-- Modal Particularités Ajout-->
    ...
    <div class=\"modal-dialog modal-dialog\" role=\"decorum\">
        ...
        // line 36
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_sort_filter($this->env, ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["listes"] ?? null), 0, [], "array", false, true, false, 36), "source", [], "array", true, true, false, 36)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["listes"] ?? null), 0, [], "array", false, true, false, 36), "source", [], "array", false, false, false, 36), [])) : ([]))));
        foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
            // line 37
            echo "                            <option value=\"";
            echo twig_escape_filter($this->env, $context["name"], "html", null, true);
...
", "FormsAdd/decorum.html.twig", "/Applications/MAMP/htdocs/bo-FIND/templates/FormsAdd/decorum.html.twig");
    }
}
